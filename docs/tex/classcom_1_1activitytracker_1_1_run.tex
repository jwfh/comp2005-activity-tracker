...
\begin{DoxyCode}{0}
\DoxyCodeLine{66                                                    \{}
\DoxyCodeLine{67         this.\textcolor{keywordtype}{id} = rID;}
\DoxyCodeLine{68         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}} = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}};}
\DoxyCodeLine{69         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a2f519da043ea384f1ba0d156f4971367}{runDate}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a1bef7a6f466db41b1a6da7a502d35bb9}{getRunDate}}(rID);}
\DoxyCodeLine{70         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.DURATION, rID);}
\DoxyCodeLine{71         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.DISTANCE, rID);}
\DoxyCodeLine{72         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ada0c6e189d55997133cde5bbe9913984}{speed}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}} / this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}};}
\DoxyCodeLine{73         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ad28bf8d709b4cfcdb93a51033a90728c}{altitudeAscended}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_ASCENDED, rID);}
\DoxyCodeLine{74         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a4997349f78c9147a30811306c2ab5223}{altitudeDescended}} = this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_DESCENDED, rID);}
\DoxyCodeLine{75         this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_aa4c73467653a47d3b14ff6653bbab853}{caloriesBurned}} = 0;}
\DoxyCodeLine{76     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!bulkImport@{bulkImport}}
\index{bulkImport@{bulkImport}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{194                                                       \{}
\DoxyCodeLine{195         BufferedReader br = \textcolor{keyword}{new} BufferedReader(\textcolor{keyword}{new} FileReader(filePath));}
\DoxyCodeLine{196         String line = \textcolor{keyword}{null};}
\DoxyCodeLine{197         Date date = \textcolor{keyword}{null};}
\DoxyCodeLine{198         \textcolor{keywordflow}{while} ((line = br.readLine()) != \textcolor{keyword}{null})  }
\DoxyCodeLine{199         \{}
\DoxyCodeLine{200             String[] attributes = line.split(\textcolor{stringliteral}{","});}
\DoxyCodeLine{201             String buffTime = attributes[0];}
\DoxyCodeLine{202             String buffDistance = attributes[1];}
\DoxyCodeLine{203             String buffAltitude = attributes[2];}
\DoxyCodeLine{204             String buffDate = attributes[3];}
\DoxyCodeLine{205             DateFormat sourceFormat = \textcolor{keyword}{new} SimpleDateFormat(\textcolor{stringliteral}{"dd-MM-yyyy"});}
\DoxyCodeLine{206             \textcolor{keywordflow}{try} \{}
\DoxyCodeLine{207                 date = sourceFormat.parse(buffDate);}
\DoxyCodeLine{208             \}}
\DoxyCodeLine{209             \textcolor{keywordflow}{catch} (\textcolor{keyword}{final} ParseException e) \{}
\DoxyCodeLine{210                 System.err.println(e.getMessage());}
\DoxyCodeLine{211             \}}
\DoxyCodeLine{212 }
\DoxyCodeLine{213             \textcolor{comment}{// Convert strings to floats}}
\DoxyCodeLine{214             \textcolor{keywordtype}{float} fDur = Float.parseFloat(buffTime);}
\DoxyCodeLine{215             \textcolor{keywordtype}{float} fDist = Float.parseFloat(buffDistance);}
\DoxyCodeLine{216             \textcolor{keywordtype}{float} fAlt = Float.parseFloat(buffAltitude);}
\DoxyCodeLine{217 }
\DoxyCodeLine{218             \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5dea6f1860431103d553ce770382afe0}{newRunDataPoint}}(\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}, user, fDur, date, fDist, fAlt);}
\DoxyCodeLine{219         \} }
\DoxyCodeLine{220     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getAltitudeAscended@{getAltitudeAscended}}
\index{getAltitudeAscended@{getAltitudeAscended}!com.activitytracker.Run@{com.activitytracker.Run}}
\subsubsection{\texorpdfstring{getAltitudeAscended()}{getAltitudeAscended()}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{263                                        \{}
\DoxyCodeLine{264         BigDecimal a = \textcolor{keyword}{new} BigDecimal(\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ad28bf8d709b4cfcdb93a51033a90728c}{altitudeAscended}});}
\DoxyCodeLine{265         \textcolor{keywordflow}{return} a.setScale(3, RoundingMode.UP).floatValue();}
\DoxyCodeLine{266     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getAltitudeDescended@{getAltitudeDescended}}
\index{getAltitudeDescended@{getAltitudeDescended}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{273                                         \{}
\DoxyCodeLine{274         BigDecimal a = \textcolor{keyword}{new} BigDecimal(\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a4997349f78c9147a30811306c2ab5223}{altitudeDescended}});}
\DoxyCodeLine{275         \textcolor{keywordflow}{return} a.setScale(3, RoundingMode.UP).floatValue();}
\DoxyCodeLine{276     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getDistance@{getDistance}}
\index{getDistance@{getDistance}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{245                                \{}
\DoxyCodeLine{246         \textcolor{keywordflow}{return} \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}};}
\DoxyCodeLine{247     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getDuration@{getDuration}}
\index{getDuration@{getDuration}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{236                                \{}
\DoxyCodeLine{237         \textcolor{keywordflow}{return} \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}};}
\DoxyCodeLine{238     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getID@{getID}}
\index{getID@{getID}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{227                        \{}
\DoxyCodeLine{228         \textcolor{keywordflow}{return} this.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_aa76717aee690b5bfe919d6e87dea1d84}{id}};}
\DoxyCodeLine{229     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getRunDate@{getRunDate}}
\index{getRunDate@{getRunDate}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{283                              \{}
\DoxyCodeLine{284         \textcolor{keywordflow}{return} \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a2f519da043ea384f1ba0d156f4971367}{runDate}};}
\DoxyCodeLine{285     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getRuns@{getRuns}}
\index{getRuns@{getRuns}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{163                                                                                 \{}
\DoxyCodeLine{164         Vector<Run> runs = \textcolor{keyword}{new} Vector<>();}
\DoxyCodeLine{165         \textcolor{keywordtype}{int} rID;}
\DoxyCodeLine{166         Vector<Integer> rIDs = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a48d9e51c1b73064b8f773cdde5113928}{getRuns}}(user.getID(), startDate, endDate);}
\DoxyCodeLine{167 }
\DoxyCodeLine{168         \textcolor{keywordflow}{if} (rIDs != \textcolor{keyword}{null}) \{}
\DoxyCodeLine{169             Iterator<Integer> runIDIter = rIDs.iterator();}
\DoxyCodeLine{170             \textcolor{keywordflow}{while} (runIDIter.hasNext()) \{}
\DoxyCodeLine{171                 rID = runIDIter.next();}
\DoxyCodeLine{172                 runs.add(\textcolor{keyword}{new} \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5568c1c514835056d2abc22cfba222c5}{Run}}(\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}, rID));}
\DoxyCodeLine{173             \}}
\DoxyCodeLine{174             \textcolor{keywordflow}{return} runs;}
\DoxyCodeLine{175         \}}
\DoxyCodeLine{176         \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{177             System.err.println(\textcolor{stringliteral}{"DBManager.getRuns() returned null."});}
\DoxyCodeLine{178             \textcolor{keywordflow}{return} \textcolor{keyword}{null};}
\DoxyCodeLine{179         \}}
\DoxyCodeLine{180     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!getSpeed@{getSpeed}}
\index{getSpeed@{getSpeed}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{254                             \{}
\DoxyCodeLine{255         \textcolor{keywordflow}{return} \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ada0c6e189d55997133cde5bbe9913984}{speed}};}
\DoxyCodeLine{256     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!newRunDataPoint@{newRunDataPoint}}
\index{newRunDataPoint@{newRunDataPoint}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{103                                                                                                \{}
\DoxyCodeLine{104         \textcolor{keywordtype}{int} userID = user.getID();}
\DoxyCodeLine{105         \textcolor{keywordtype}{int} rID;}
\DoxyCodeLine{106         \textcolor{keywordtype}{float} altitude\_ascended;}
\DoxyCodeLine{107         \textcolor{keywordtype}{float} altitude\_descended;}
\DoxyCodeLine{108 }
\DoxyCodeLine{109         \textcolor{keywordflow}{if} (\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}} == 0f \&\& \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}} == 0f \&\& altitude == 0f) \{}
\DoxyCodeLine{110             altitude\_ascended = 0f;}
\DoxyCodeLine{111             altitude\_descended = 0f;}
\DoxyCodeLine{112             rID = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_ae0504a939b6f165aa5c3cca9eb8df049}{newRun}}(}
\DoxyCodeLine{113                     userID,}
\DoxyCodeLine{114                     date,}
\DoxyCodeLine{115                     \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}},}
\DoxyCodeLine{116                     \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}},}
\DoxyCodeLine{117                     altitude\_ascended,}
\DoxyCodeLine{118                     altitude\_descended}
\DoxyCodeLine{119             );}
\DoxyCodeLine{120             user.setLastRID(rID);}
\DoxyCodeLine{121             System.err.println(\textcolor{stringliteral}{"Run "} + Integer.toString(rID) + \textcolor{stringliteral}{" added to database."});}
\DoxyCodeLine{122         \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{123             rID = user.getLastRID();}
\DoxyCodeLine{124             \textcolor{keywordflow}{if} (\mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a723ac1c573bacdd0b62894357bd65a9b}{runExists}}(rID)) \{}
\DoxyCodeLine{125                 altitude\_ascended = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_ASCENDED, rID);}
\DoxyCodeLine{126                 altitude\_descended = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_DESCENDED, rID);}
\DoxyCodeLine{127 }
\DoxyCodeLine{128                 System.err.println(\textcolor{stringliteral}{"Altitude: "} + Float.toString(altitude) + \textcolor{stringliteral}{", +: "} + Float.toString(altitude\_ascended) + \textcolor{stringliteral}{", -: "} + Float.toString(altitude\_descended));}
\DoxyCodeLine{129                 \textcolor{keywordflow}{if} (altitude < altitude\_ascended-altitude\_descended) \{}
\DoxyCodeLine{130                     altitude\_descended += altitude\_ascended - altitude\_descended - altitude;}
\DoxyCodeLine{131                     System.err.println(\textcolor{stringliteral}{"Went down "} + Float.toString(altitude\_ascended - altitude\_descended - altitude));}
\DoxyCodeLine{132                 \}}
\DoxyCodeLine{133                 \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{134                     altitude\_ascended += altitude - (altitude\_ascended - altitude\_descended);}
\DoxyCodeLine{135                     System.err.println(\textcolor{stringliteral}{"Went up "} + Float.toString(altitude - altitude\_ascended - altitude\_descended));}
\DoxyCodeLine{136                 \}}
\DoxyCodeLine{137 }
\DoxyCodeLine{138                 \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_aa088e156858d8d661e2f43c1054c51c8}{setRun}}(rID, \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a5e38d293d29d4b65c9290ff4bee82e03}{duration}}, \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_a7b4ca8c4ecea4da1653f03b8c8fc16a8}{distance}}, altitude\_ascended, altitude\_descended);}
\DoxyCodeLine{139                 System.err.println(\textcolor{stringliteral}{"Run "} + Integer.toString(rID) + \textcolor{stringliteral}{" exists in the database; updating..."});}
\DoxyCodeLine{140             \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{141                 System.err.println(\textcolor{stringliteral}{"Run table and User table are inconsistent. No changes made."});}
\DoxyCodeLine{142             \}}
\DoxyCodeLine{143         \}}
\DoxyCodeLine{144 }
\DoxyCodeLine{145         altitude\_ascended = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_ASCENDED, rID);}
\DoxyCodeLine{146         altitude\_descended = \mbox{\hyperlink{classcom_1_1activitytracker_1_1_run_ab90e32eda9f4c671ae3575f971edca6b}{dbManager}}.\mbox{\hyperlink{classcom_1_1activitytracker_1_1_d_b_manager_a666452f1e5862f90c06b0beb9a9fcfdd}{getRunFloatAttribute}}(RunAttribute.ALTITUDE\_DESCENDED, rID);}
\DoxyCodeLine{147 }
\DoxyCodeLine{148         System.err.println(\textcolor{stringliteral}{"+: "} + Float.toString(altitude\_ascended) + \textcolor{stringliteral}{", -: "} + Float.toString(altitude\_descended));}
\DoxyCodeLine{149     \}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!altitudeAscended@{altitudeAscended}}
\index{altitudeAscended@{altitudeAscended}!com.activitytracker.Run@{com.activitytracker.Run}}
\subsubsection{\texorpdfstring{altitudeAscended}{altitudeAscended}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!altitudeDescended@{altitudeDescended}}
\index{altitudeDescended@{altitudeDescended}!com.activitytracker.Run@{com.activitytracker.Run}}
\subsubsection{\texorpdfstring{altitudeDescended}{altitudeDescended}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!caloriesBurned@{caloriesBurned}}
\index{caloriesBurned@{caloriesBurned}!com.activitytracker.Run@{com.activitytracker.Run}}
\subsubsection{\texorpdfstring{caloriesBurned}{caloriesBurned}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!dbManager@{dbManager}}
\index{dbManager@{dbManager}!com.activitytracker.Run@{com.activitytracker.Run}}
...
\index{com.activitytracker.Run@{com.activitytracker.Run}!runDate@{runDate}}
\index{runDate@{runDate}!com.activitytracker.Run@{com.activitytracker.Run}}
